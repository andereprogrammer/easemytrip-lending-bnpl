...
function EmtMoneyCard() {
  ...
  const [customerDetails, setCustomerDetails] = React.useState({ email: "",mobileNumber:"",namePan:""
})
      ...
      <div className="emt_main_wrapper">
        ...
        <div className="right">
          <div className="inputField" id="inputMoney">
            <input type="text" name="mobileNumber" placeholder="Enter mobile number" value={customerDetails.mobileNumber} onChange={handleDetails} />
            <button onClick={() => showMoney()}>Check Eligibility</button>
          </div>
          <div className="inputField" id="inputName" style={{
            display:'none'
          }}>
            <input type="text" name="namePan" placeholder="Enter your name" value={customerDetails.namePan} onChange={handleDetails} />
